...
export const apps: AppProject[] = [
  {
    ...
    description:
      "Your daily Islamic companion — accurate prayer times, Quran & Hadith with English and Urdu, Qibla compass, 60+ duas & azkar, digital Tasbih, and per-salah alarms. Bilingual, offline-capable, and privacy-first.",
  ...
  },
  {
    ...
    description:
      "An AI-powered fitness & nutrition app for gym-goers — plan workouts, track nutrition, hit PRs with video-guided form cues, and an adaptive AI coach built for Android.",
    ...
    features: [
      ...
      "Body metrics — BMI, WHR, TDEE, BMR tracking",
